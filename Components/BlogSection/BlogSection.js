...
// import blogImg2 from "../../public/Images/blogCover2.PNG";
// import blogImg3 from "../../public/Images/blogCover3.PNG";
  ...
  return (
    <div id="blog">
      ...
      <div className={styles.blogWrapper}>
        <BlogCard
          blogLink={link1}
          bgImg={"./Images/blogCover.jpeg"}
          title={content1.title}
          parah={content1.parah}
        />
        <BlogCard
          blogLink={link2}
          bgImg={"./Images/blogCover2.PNG"}
          title={content2.title}
          parah={content2.parah}
        />
        <BlogCard
          blogLink={link3}
          bgImg={"./Images/blogCover3.PNG"}
